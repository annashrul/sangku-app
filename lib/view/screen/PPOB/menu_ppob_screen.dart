                  ...
                  child: Column(
                    children: [
                      toArray[2]=='svg'?SvgPicture.network(
                        ...
                        fit:BoxFit.contain,
                        height: 50.0,
                        placeholderBuilder: (BuildContext context) => Image.network(Constant().noImage, fit:BoxFit.fill,width: double.infinity,),
                      ):CachedNetworkImage(
                        imageUrl:val.logo,
                      ...
                      SizedBox(height:5.0),
                      WidgetHelper().textQ(val.title,8,Constant().darkMode, FontWeight.bold,textAlign: TextAlign.center,maxLines: 1),
                    ],
                  )
              );
            },
