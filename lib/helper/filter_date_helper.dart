              ...
              child: Row(
                ...
                children: [
                  FlatButton(
                    ...
                    child: WidgetHelper().textQ(widget._cancelText, 12, Constant().darkMode,FontWeight.bold),
                  ),
                  FlatButton(
                    onPressed: () {
                    ...
                    child: WidgetHelper().textQ(widget._doneText, 12, Constant().darkMode,FontWeight.bold),
                  )
                ],
              ),
            )
